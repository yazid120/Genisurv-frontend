...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="block mr-1 font-medium text-theme-sm">{user?.nom || "Utilisateur"}</span>
        <svg
  ...
  {user?.email_verification ? (
    <div className="flex items-center gap-3 px-3 py-2 font-medium text-green-600 rounded-lg cursor-default text-theme-sm">
    ...
    <DropdownItem
      ...
      className="flex items-center gap-3 px-3 py-2 font-medium text-red-600 rounded-lg group text-theme-sm hover:bg-red-50"
    >
      <svg
        width="22"
        height="22"
