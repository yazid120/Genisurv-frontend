...
import { getAlimentations, createAlimentation, updateAlimentation, deleteAlimentation } from "../../api/alimentations.api";
...
const initialForm: AlimentationForm = {
  caisse_id: "",
  montant: "",
};
...
export default function AlimentationsPage() {
  ...
  const [form, setForm] = useState<AlimentationForm>(initialForm);
  ...
  const [itemToDelete, setItemToDelete] = useState<Alimentation | null>(null);
  ...
  const handleOpenDelete = (item: Alimentation) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      await deleteAlimentation(itemToDelete.id);
  ...
  return (
    <>
      <PageMeta
        title="Gestion des Alimentations"
        description="Page de gestion des alimentations"
      />
                ...
                {alimentations.length === 0 ? (
                  ...
                  alimentations.map((item) => (
                    ...
                    >
                      ...
                      <TableCell className="px-5 py-4 text-right text-sm font-semibold text-blue-600 dark:text-blue-400">
      ...
      >
        ...
        <p className="mb-6 text-sm text-gray-600 dark:text-gray-400">
          Êtes-vous sûr de vouloir supprimer cette alimentation de{" "}
